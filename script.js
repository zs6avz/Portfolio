...
document.querySelectorAll('.timeline-item, .education-card, .skill-category, .project-card, .stat-item').forEach(el => {
    el.style.opacity = '0';
...
console.log('%cInterested in how this site was built?', 'color: #764ba2; font-size: 14px;');
console.log('%cFeel free to explore the code!', 'color: #667eea; font-size: 14px;');
